...
jQuery.fn.tubular = function(videoId,wrapperId) {
	t = setTimeout("resizePlayer()",3000);
	jQuery('html,body').css('height','100%');
	jQuery('body').prepend('<div id="yt-container" style="overflow: hidden; position: fixed; z-index: -10;"><div id="ytapiplayer">You need Flash player 8+ and JavaScript enabled to view this video.</div></div><div id="video-cover" style="position: fixed; width: 100%; height: 100%; z-index: -20;"></div>');
...
function resizePlayer() {
	...
	var newHeight = jQuery(window).height() + 30; // original page height
